...
from faceapp.forms import (
    ...
    CourseRegForm,VerifyPictureForm,
)
...
def verify(request):
    if request.method =="POST":
        data= request.GET.get('context', None)
        ...
        while True:
            ...
            imgS = cv2.resize(data, (0, 0), None, 0.25, 0.25, interpolation= cv2.INTER_AREA)
            ...
            for encodeFace, faceLoc in zip(encodeCurFrame, facesCurFrame):
                ...
                if matches[matchIndex]:
                    ...
                    cv2.rectangle(data, (x1, y2-35), (x2, y2), (0, 255, 0), cv2.FILLED)
                    cv2.putText(data, name(x1+6, y2-6), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2)
